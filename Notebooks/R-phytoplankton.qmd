...
Plot with both phytoplankton and zooplankton abundance. Removed legends because of space. Colors are functional groups.
...
ggsave("../Figures/phyto-zooplankgon.png", dpi = 300, width = 7, height = 4)
```
